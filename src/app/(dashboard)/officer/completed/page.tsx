...
export default function CompletedCasesPage() {
 ...
 Completed <span className="text-emerald-650">Case Archives</span>
 </h1>
 ...
 <option value="resolved" className="">Resolved</option>
 ...
 className="bg-transparent text-xs text-slate-755 focus:outline-none cursor-pointer capitalize font-bold"
 >
 ...
 <RefreshCw className="h-8 w-8 text-orange-555 animate-spin" />
 ...
 <h3 className="text-lg font-bold text-slate-850 mb-1">No Completed Cases</h3>
 ...
 <td className="px-6 py-4 text-xs font-mono font-bold text-orange-650">
 ...
 variant="ghost"
 size="sm"
 className="text-orange-655 hover:text-orange-500 hover:bg-orange-500/10 gap-1.5 font-bold uppercase tracking-wider text-[10px]"
 >
 View Work
