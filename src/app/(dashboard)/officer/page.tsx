...
export default function OfficerDashboardPage() {
 ...
 Official Workspace: <span className="text-orange-600">{profile?.displayName}</span>
 </h1>
 ...
 {/* Stat Card 1: Pending */}
 <div className="clay-card p-6 relative group overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_rgba(249,115,22,0.08)]">
 ...
 <span className="text-xs text-slate-450">Awaiting initial review</span>
 </div>
 </div>

 {/* Stat Card 2: Assigned */}
 <div className="clay-card p-6 relative group overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_rgba(59,130,246,0.08)]">
 ...
 <span className="text-xs text-slate-450">Under active resolution</span>
 </div>
 </div>

 {/* Stat Card 3: Resolved Today */}
 <div className="clay-card p-6 relative group overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_rgba(16,185,129,0.08)]">
 ...
 <span className="text-xs text-slate-450">Closed in the last 24h</span>
 </div>
 </div>

 {/* Stat Card 4: Average Resolution Time */}
 <div className="clay-card p-6 relative group overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_rgba(249,115,22,0.08)]">
 <div className="absolute top-0 right-0 p-4 opacity-10 text-orange-450 group-hover:opacity-20 transition-opacity">
 <AlertCircle className="h-16 w-16" />
 </div>
 <div className="flex flex-col gap-2">
 <span className="text-xs font-bold uppercase tracking-wider text-orange-655">
 Avg Resolution Time
 </span>
 <span className="text-4xl font-black text-slate-800">
 {loading ?"..." : avgResolutionTime}
 </span>
 <span className="text-xs text-slate-455">Incident resolution cycle</span>
 </div>
 </div>
 </div>

 {/* Interactive Incident Table */}
 <div className="clay-card overflow-hidden flex flex-col p-0">
 {/* Tab Navigation */}
 <div className="flex flex-wrap border-b border-slate-200 bg-slate-100/50 px-6 gap-6 pt-4">
 <button
 ...
 >
 Assigned
 <span className="bg-orange-500/10 text-orange-600 text-[10px] font-mono px-1.5 py-0.5 rounded border border-orange-500/20">
 {assignedTabCount}
 </span>
 </button>
 <button
 ...
 className="pl-9 pr-4 py-1.5 bg-white border border-slate-200 rounded-2xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-orange-500 w-64 shadow-inner"
 />
 </div>

 {/* Category Filter */}
 <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded-2xl px-3 py-1.5 shadow-inner">
 ...
 <option value="road_damage" className="">Road Damage</option>
 <option value="garbage" className="">Garbage</option>
 <option value="water_leakage" className="">Water Leakage</option>
 <option value="street_light" className="">Street Light</option>
 <option value="drainage" className="">Drainage</option>
 <option value="illegal_dumping" className="">Illegal Dumping</option>
 <option value="traffic_signal" className="">Traffic Signal</option>
 <option value="public_safety" className="">Public Safety</option>
 ...
 {loading ? (
 <div className="py-24 text-center text-slate-400 text-sm animate-pulse font-medium">
 Synchronizing data registries...
 </div>
) : error ? (
 <div className="py-24 text-center text-rose-600 text-sm font-bold">{error}</div>
) : filteredReports.length === 0 ? (
 <div className="py-24 text-center text-slate-450 text-sm font-medium">
 ...
 return (
 <span
 className={`text-[9px] font-extrabold uppercase tracking-wider px-2.5 py-0.5 rounded-full self-start ${
 severity ==="critical"
 ...
 Priority:
 <strong className="capitalize text-slate-600 font-bold">
 {report.ai.verification.priority}
 </strong>
 </span>
)}
 ...
 <td className="px-6 py-4">
 <span
 className={`text-xs px-2.5 py-1 rounded-full font-bold inline-block border ${
