 ...
 * Protected by RouteGuard with admin role restriction.
 */
        ...
        <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-12 flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              Manage platform accounts, oversee incident reports, audit system dispatches, and modify configurations.
            </p>
          </div>

          <div className="border border-border rounded-lg p-6 bg-card flex flex-col gap-4">
            <h2 className="text-lg font-semibold text-destructive">System Administrator Card</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-xs text-muted-foreground">Admin Contact</span>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="font-medium capitalize text-destructive">{profile?.role}</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-xs text-muted-foreground">System Audit Mode</span>
