...
export default function BeforeAfterGallery({ report }: BeforeAfterGalleryProps) {
 ...
 <div>
 <h3 className="text-lg font-bold text-slate-800">Resolution & Proof Gallery</h3>
 <span className="text-xs text-slate-500">Verifying structural cleanup & repairs</span>
 </div>
 </div>
 ...
 <div className="aspect-[4/3] rounded-xl border border-dashed border-slate-200 bg-slate-100/30 flex items-center justify-center text-xs text-slate-500">
 ...
 />
 <div className="absolute inset-0 clay-card p-5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-slate-200 pt-6 text-sm">
 {/* Details and Materials */}
 <div className="space-y-4">
 <div className="grid grid-cols-2 gap-4">
 <div className="p-3 rounded-xl bg-white/5 border border-slate-200">
 <span className="text-[10px] font-bold text-slate-500 uppercase block tracking-wider">Assigned Department</span>
 <span className="text-sm font-semibold text-slate-700">{report.ai?.assignment?.department ||"General Operations"}</span>
 </div>
 <div className="p-3 rounded-xl bg-white/5 border border-slate-200">
 <span className="text-[10px] font-bold text-slate-500 uppercase block tracking-wider">Resolved By</span>
 <span className="text-sm font-semibold text-slate-700">{resolution?.resolvedBy ||"Field Officer"}</span>
 </div>
 </div>

 <div className="space-y-2">
 <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Materials Used</span>
 <p className="p-4 rounded-xl bg-white/5 border border-slate-200 text-slate-700 leading-relaxed min-h-[50px] whitespace-pre-wrap">
 {resolution?.materialsUsed ||"None specified."}
 </p>
 </div>

 <div className="space-y-2">
 <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Work Completed</span>
 <p className="p-4 rounded-xl bg-white/5 border border-slate-200 text-slate-700 leading-relaxed min-h-[50px] whitespace-pre-wrap">
 ...
 <div className="space-y-2">
 <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Field Officer Notes</span>
 <p className="p-4 rounded-xl bg-white/5 border border-slate-200 text-slate-700 min-h-[80px] leading-relaxed whitespace-pre-wrap">
 {officerNotes}
 </p>
 </div>
 </div>
 ...
 <div className="space-y-2">
 <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">AI Resolution Audit</span>
 <div className="p-4 rounded-xl bg-white/5 border border-slate-200 text-slate-700 min-h-[250px] space-y-4 leading-relaxed">
 {aiSummary ? (
 <>
 <div>
 <span className="text-[10px] font-bold text-blue-400 uppercase block tracking-wider">Technical Summary</span>
 <span className="text-xs text-slate-600 block mt-1">{aiSummary.summary ||"No technical summary calculated."}</span>
 </div>
 ...
 <span className="text-xs text-slate-600 block mt-1">{aiSummary.workCompleted}</span>
 </div>
)}
 ...
 <span className="text-xs text-slate-600 block mt-1">{aiSummary.citizenExplanation}</span>
 </div>
)}
 </>
) : (
 <span className="text-xs text-slate-500 italic">No AI Resolution summary calculated.</span>
)}
 </div>
 </div>
 </div>
 ...
 className="absolute top-4 right-4 p-2 rounded-full bg-white/10 text-slate-800 hover:bg-white/20 transition"
 ...
 className="absolute left-4 p-2 rounded-full bg-white/10 text-slate-800 hover:bg-white/20 transition"
 ...
 className="absolute right-4 p-2 rounded-full bg-white/10 text-slate-800 hover:bg-white/20 transition"
 ...
 alt="Zoomed evidence" 
 className="max-w-full max-h-[70vh] object-contain rounded-lg border border-slate-200 shadow-2xl"
 />
 <span className="text-xs font-semibold px-3 py-1 rounded bg-slate-100 border border-slate-200 uppercase tracking-widest text-slate-600">
