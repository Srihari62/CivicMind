    ...
    <div className="w-full rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-md shadow-2xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-lg font-bold text-white">Live Verification Pipeline</h3>
            <span className="text-xs text-zinc-400">Verifying civic integrity matches</span>
          </div>
        </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className={`${stage.isCompleted ? "text-zinc-400" : isCurrent ? "text-blue-400 font-medium" : "text-zinc-500"}`}>
                  {stage.label}
                </span>
              </div>
              <div>
