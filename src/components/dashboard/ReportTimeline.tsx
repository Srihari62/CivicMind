...
export default function ReportTimeline({ report }: ReportTimelineProps) {
 ...
 return (
 <div className="w-full rounded-2xl clay-card p-6">
 ...
 <div className="absolute left-[19px] top-4 bottom-4 w-0.5 bg-slate-200 md:hidden z-0" />
 ...
 <div className="w-10 h-10 rounded-full bg-blue-600 border-2 border-blue-400 flex items-center justify-center text-slate-800 shadow-[0_0_15px_rgba(59,130,246,0.6)]">
 ...
 <span className={`text-sm font-bold ${step.isCompleted ?"text-emerald-400" : step.isCurrent ?"text-blue-400 font-extrabold" :"text-slate-500"}`}>
 {step.label}
 </span>
 <span className="text-xs text-slate-500 max-w-[150px] leading-snug md:line-clamp-2">
 {step.description}
 </span>
 </div>
 </div>
