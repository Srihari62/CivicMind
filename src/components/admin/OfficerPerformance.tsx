    ...
    <div className="w-full rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-md shadow-2xl space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-white/5 pb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-lg font-bold text-white">Officer Performance Audit</h3>
            <span className="text-xs text-zinc-400">Municipal service response and dispatch telemetry</span>
          </div>
        </div>
      </div>
                  ...
                  >
                    <td className="px-4 py-4.5 flex items-center gap-3">
                      <div className="relative">
                        <div className="w-9 h-9 rounded-full bg-zinc-800 border border-white/10 flex items-center justify-center font-bold text-zinc-300 text-xs overflow-hidden">
                    ...
                    <td className="px-4 py-4.5 text-center font-mono font-bold text-zinc-300">
                      {stat.assignedCount}
                    </td>
                    <td className="px-4 py-4.5 text-center font-mono font-bold text-zinc-300">
                      {stat.resolvedCount}
                    ...
                    <td className="px-4 py-4.5 font-mono text-zinc-400">
                      {stat.avgHours > 0 ? (
                    ...
                    <td className="px-4 py-4.5 text-right font-mono font-black text-sm">
                      <span className={stat.efficiencyScore >= 80 ? "text-emerald-400" : stat.efficiencyScore >= 60 ? "text-blue-400" : "text-zinc-400"}>
