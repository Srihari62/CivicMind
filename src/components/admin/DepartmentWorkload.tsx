...
export default function DepartmentWorkload({ reports }: DepartmentWorkloadProps) {
 ...
 <div 
 key={dept.name} 
 className="p-4 clay-card p-5 hover:border-slate-200 transition-all space-y-3.5"
 >
 {/* Dept Title & Total Workload */}
 <div className="flex justify-between items-center">
 <span className="font-extrabold text-slate-800 text-sm">{dept.name}</span>
 <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-slate-100 border border-slate-200 text-slate-600">
 ...
 {/* Grid of details */}
 <div className="grid grid-cols-4 gap-2 text-center text-[10px] text-slate-500 border-t border-slate-200 pt-3 mt-1">
 ...
 <span className="text-slate-600 font-black font-mono text-xs flex items-center justify-center gap-0.5">
