...
export default function ExecutiveSummary({ reports, avgResolutionTime }: ExecutiveSummaryProps) {
  ...
  return (
    <div className="w-full rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-md shadow-2xl space-y-6 relative overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-white/5 pb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-lg font-bold text-white">AI Executive Command Summary</h3>
            <span className="text-xs text-zinc-400 font-mono">Gemini-powered live municipal briefing</span>
          </div>
        </div>
        <button
      ...
      {loading ? (
        <div className="space-y-4 py-8 animate-pulse">
          ...
          <div className="h-4 w-[90%] bg-zinc-800 rounded" />
          <div className="h-4 w-[95%] bg-zinc-800 rounded" />
          <div className="h-4 w-[85%] bg-zinc-800 rounded" />
        </div>
      ) : error || !summary ? (
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-xl bg-white/5 border border-white/5 space-y-1.5">
                ...
                <span className="font-bold text-zinc-300 text-xs block leading-relaxed">
