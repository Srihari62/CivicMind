    ...
    >
      ...
      <div
        className={`max-w-[85%] rounded-2xl px-4 py-3 text-xs leading-relaxed shadow-sm ${
          isModel
            ? "border border-white/5 bg-zinc-900/60 text-zinc-200 backdrop-blur-sm"
            : "bg-gradient-to-r from-red-500 to-rose-500 text-white font-medium"
        }`}
      >
        {isModel ? (
      ...
      {!isModel && (
        <div className="flex h-8 w-8 shrink-0 select-none items-center justify-center rounded-full border border-white/10 bg-zinc-900 text-zinc-300">
